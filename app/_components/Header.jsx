...
function Header() {
  ...
  <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8 shadow-md ">
    <Image src='/logo.svg' alt="logo" width={28} height={28} className="h-20 w-20" />
    ...
    <div className="flex flex-1 items-center justify-end md:justify-between">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          className="block rounded bg-gray-100 p-2.5 text-gray-600 transition hover:text-[#2b24ad]/75 md:hidden"
        >
