    ...
    <>
      <header>
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 ">
          <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl shadow-md px-1 h-16 ">
          <Link href="/">
            <Image
              src="/logo.svg"
              alt="logo"
            ...
            <div
              class={`${click ? 'block text-center bg-gray-300 mt-2 rounded-md z-50 ' : 'hidden'} justify-around items-center w-full md:flex md:w-auto md:order-1`}
              id="mobile-menu-2"
            >
              <ul class="flex flex-col gap-2 mt-4 font-medium md:flex-row md:space-x-8 md:mt-0">
                <li>
                  <a
                    href="#"
