      ...
      <footer className="bg-white">
        <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-md">
            ...
            <form action="mailto:aymanmae12@gmail.com" className="mt-6">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
            <div className="mx-auto max-w-sm lg:max-w-none">
              ...
              We are honored to see you on our website and <br /> glad to see you every second.              </p>
              ...
              <div className="mt-6 flex justify-center gap-4 lg:justify-start">
                ...
                <a
                  className="text-gray-700 transition hover:text-gray-700/75"
                  href="https://linkedin.com/in/ayman-ezzeldin"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  className="text-gray-700 transition hover:text-gray-700/75"
                  href="https://x.com/AymanEz95639617"
                  target="_blank"
                  rel="noreferrer"
                >
